...
— seven landmark kinds (pool, statues, spiral, columns, dais, well, balls), five
of them answering to you (the ball pit, the spiral, the columns, the statues and
the well, which is a hole you cannot walk into); **a key vault** in every level; dead ends as loot slots;
