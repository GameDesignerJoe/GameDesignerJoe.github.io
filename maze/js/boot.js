...
{ const run = SAVE.run;
  if (run && run.phase === (SAVE.phase || 0) && run.stones === (SAVE.stones || 0) && run.pool === !!SAVE.poolPending && (run.size || 'auto') === (SAVE.ui.size || 'auto') && (run.branch || 'auto') === (SAVE.ui.branch || 'auto') && (run.braid || 'auto') === (SAVE.ui.braid || 'auto') && (run.turns || 'auto') === (SAVE.ui.turns || 'auto') && (run.clusters || 'auto') === (SAVE.ui.clusters || 'auto')) {
