...
// 20 plain scripts sharing one global scope: order is load-bearing. Reordering
...
const EXPECTED = [
  ...
  'js/core.js', 'js/generate.js', 'js/proto.js', 'js/districts.js', 'js/contract.js', 'js/audio.js', 'js/state.js', 'js/input.js',
