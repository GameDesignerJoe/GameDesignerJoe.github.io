...
- Being able to have the teach add scales themselves directly into the program. Perhaps an editor mode. 
- Flats and sharps note names. Sometimes we want one or the other. clicking on a note to change. A toggle button for flat or sharp. It changes all of them. 
