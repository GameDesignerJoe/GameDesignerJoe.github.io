...
- A settings option somewhere that has a handful of controls:
    - Flats Sharps toggle
    - Left-Handed flip
    - Color themes
    - Instructions
...
- Flats and sharps note names. Some of the notes are actually the same, but are the sharp or flat version. The teacher wants to have a toggle that displays either the flat or sharp option depending on the gottle. It changes all those notes that could go one way or the other. 
...
- Bug: when you take away the 0 fret then some other frets and add the 0 fret back in, the circles that show the 0 fret are oval and squished. I would like them to stay circles and maintain their size. However, I do want them overall to be about half the size as the regular notes. 
...
- Color themes as well. We put together a couple different color pallets that range from Light Mode, Black & White, White & Black, High Contrast, and one or two others to give some variety to what the thing can look like.
