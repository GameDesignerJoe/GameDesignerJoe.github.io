...
const questions = {
    1: [
        ...
        { 
            text: "Do you want to use a pacifier?", 
        ...
        { 
            text: "Do you want to use a baby monitor?", 
            yes: "You have chosen to use a baby monitor.", 
            no: "You have chosen not to use a baby monitor.",
            yesLabel: "Use baby monitor",
            noLabel: "Don't use baby monitor", 
        },
        { 
            text: "Do you want to use a baby bathtub?", 
            yes: "You have chosen to use a baby bathtub.", 
            no: "You have chosen not to use a baby bathtub.",
            yesLabel: "Use baby bathtub",
            noLabel: "Don't use baby bathtub",
        },
        { 
            text: "Do you want to sleep train your baby", 
            yes: "You have chosen to sleep train your baby.", 
            no: "You have chosen not to sleep train your baby.",
            yesLabel: "Sleep train",
            noLabel: "Don't sleep train",
        },
        { 
    ...
    2: [
        { 
            text: "Do you want to send your child to a private daycare?", 
        ...
        { 
            text: "Do you want to give you child peanut butter?", 
            yes: "You have chosen to give your child peanut butter.", 
            no: "You have chosen not to give your child peanut butter.",
            yesLabel: "Give peanut butter",
            noLabel: "Don't give peanut butter",
        },
    ],
    3: [
        { 
    ...
    11: [
        { 
            text: "They find a stray animal and beg to keep it, despite your lack of resources. Do you let them bring it home or teach them the limits of compassion?", 
    ...
    12: [
        { 
            ...
            no: "You have chosen to let them balance their own time with gaming.",
            yesLabel: "Set limits",
            noLabel: "Balance time",
        },
    ],
    13: [
        { 
    ...
    16: [
        { 
            text: "Your child has just turned 16 and is really excited to start driving. Do you get them a car, knowing having an extra driver in the family will be helpful, despite the financial burden or do you put it on them as an adulting lesson to take care of it themselves? ", 
            yes: "You have chosen to get them a car.", 
            no: "You have chosen not to get them a car.",
            yesLabel: "Get them a car",
            noLabel: "Don't get them a car",
        },
    ],
    17: [
        { 
