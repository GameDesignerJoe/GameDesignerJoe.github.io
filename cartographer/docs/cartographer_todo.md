...
- Get the game zoomed in a lot more by default. [HOLD]
...
- Font is really small to read on desktop [DONE]
...
- We should pulse the quest text when you collect increase the count and then do a nice big flash when you complete it. [DONE]
