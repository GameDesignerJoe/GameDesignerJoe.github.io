...
const DEMO_STORIES = [
  {
    ...
    narrator: { name: 'Eleanor', emoji: '🕯️' },
    duration: '~12 min', paths: 4, startScene: 'start',
    scenes: {
      start: { id: 'start', title: 'The Arrival', emotion: 'curious', bgKey: 'a', bgImage: null, clips: ['lighthouse/start-a.mp3', 'lighthouse/start-b.mp3'], secondsBeforeEnd: 6, defaultChoice: 0, countdown: 5, choices: [{ text: 'Enter through the heavy iron door…', target: 'hall' }, { text: "Circle to the keeper's cottage…", target: 'cottage' }] },
      hall: { id: 'hall', title: 'The Front Hall', emotion: 'afraid', bgKey: 'b', bgImage: null, clips: ['lighthouse/hall.mp3'], secondsBeforeEnd: 7, defaultChoice: 0, countdown: 6, choices: [{ text: 'Climb the spiral stair…', target: 'lamp' }, { text: 'Search the roll-top desk…', target: 'study' }, { text: 'Step back outside and listen…', target: 'shore' }] },
      cottage: { id: 'cottage', title: "The Keeper's Cottage", emotion: 'curious', bgKey: 'b', bgImage: null, clips: ['lighthouse/cottage.mp3'], secondsBeforeEnd: 5, defaultChoice: 0, countdown: 4, choices: [{ text: 'Open the old journal on the table…', target: 'study' }, { text: 'Follow the stone path to the shore…', target: 'shore' }] },
      lamp: { id: 'lamp', title: 'The Lamp Room', emotion: 'afraid', bgKey: 'c', bgImage: null, clips: ['lighthouse/lamp-a.mp3', 'lighthouse/lamp-b.mp3'], secondsBeforeEnd: 6, defaultChoice: 1, countdown: 5, choices: [{ text: 'Reach for the brass ignition lever…', target: 'end' }, { text: 'Leave it dark and descend…', target: 'end' }] },
      study: { id: 'study', title: 'The Study', emotion: 'sad', bgKey: 'b', bgImage: null, clips: ['lighthouse/study.mp3'], secondsBeforeEnd: 5, defaultChoice: 0, countdown: 4, choices: [{ text: 'Feed the letter to the fireplace…', target: 'end' }, { text: 'Keep it and climb to the lamp room…', target: 'lamp' }] },
      shore: { id: 'shore', title: 'The Shore', emotion: 'determined', bgKey: 'c', bgImage: null, clips: ['lighthouse/shore-a.mp3', 'lighthouse/shore-b.mp3', 'lighthouse/shore-c.mp3'], secondsBeforeEnd: 7, defaultChoice: 0, countdown: 6, choices: [{ text: 'Call out across the water…', target: 'end' }, { text: 'Wade in toward the lights…', target: 'end' }] },
  ...
  },
  {
    ...
    scenes: {
      start: { id: 'start', title: 'Car Seven', emotion: 'curious', bgKey: 'a', bgImage: null, clips: ['train/start.mp3'], secondsBeforeEnd: 6, defaultChoice: 0, countdown: 5, choices: [{ text: 'Ask the man who knows your name…', target: 'man' }, { text: 'Feign sleep and watch through half-closed eyes…', target: 'sleep' }, { text: 'Walk through to the dining car…', target: 'dining' }] },
      man: { id: 'man', title: 'The Man in Seat Nine', emotion: 'afraid', bgKey: 'b', bgImage: null, clips: ['train/man.mp3'], secondsBeforeEnd: 5, defaultChoice: 1, countdown: 4, choices: [{ text: 'Tell him the truth…', target: 'end' }, { text: 'Give him the name on your forged papers…', target: 'conductor' }] },
      sleep: { id: 'sleep', title: 'Feigning Sleep', emotion: 'determined', bgKey: 'b', bgImage: null, clips: ['train/sleep-a.mp3', 'train/sleep-b.mp3'], secondsBeforeEnd: 5, defaultChoice: 0, countdown: 4, choices: [{ text: 'Open one eye when footsteps pass…', target: 'conductor' }, { text: 'Hold until the train slows…', target: 'end' }] },
      dining: { id: 'dining', title: 'The Dining Car', emotion: 'curious', bgKey: 'b', bgImage: null, clips: ['train/dining.mp3'], secondsBeforeEnd: 5, defaultChoice: 0, countdown: 4, choices: [{ text: 'Ask her where she got the photograph…', target: 'conductor' }, { text: 'Sit across from her and say nothing…', target: 'conductor' }] },
      conductor: { id: 'conductor', title: 'The Conductor', emotion: 'afraid', bgKey: 'c', bgImage: null, clips: ['train/conductor.mp3'], secondsBeforeEnd: 6, defaultChoice: 0, countdown: 5, choices: [{ text: 'Show him your ticket and hold his gaze…', target: 'end' }, { text: 'Pull the emergency brake…', target: 'end' }] },
  ...
  },
  {
    ...
    scenes: {
      start: { id: 'start', title: 'The Unmarked Shore', emotion: 'curious', bgKey: 'a', bgImage: null, clips: ['cartographer/start.mp3'], secondsBeforeEnd: 6, defaultChoice: 0, countdown: 5, choices: [{ text: 'Follow the sound of fresh water inland…', target: 'spring' }, { text: 'Begin sketching the shape of the coast…', target: 'survey' }, { text: 'Investigate the ruins on the ridge above…', target: 'ruins' }] },
      spring: { id: 'spring', title: 'The Hidden Spring', emotion: 'happy', bgKey: 'b', bgImage: null, clips: ['cartographer/spring.mp3'], secondsBeforeEnd: 5, defaultChoice: 0, countdown: 4, choices: [{ text: 'Write Edmund a note and leave it in the stones…', target: 'end' }, { text: 'Press deeper into the green…', target: 'forest' }] },
      survey: { id: 'survey', title: 'The Survey', emotion: 'determined', bgKey: 'b', bgImage: null, clips: ['cartographer/survey.mp3'], secondsBeforeEnd: 5, defaultChoice: 0, countdown: 4, choices: [{ text: 'Mark it, title it, and sign your name…', target: 'end' }, { text: 'Turn at the sound behind you…', target: 'forest' }] },
      ruins: { id: 'ruins', title: 'The Ruins', emotion: 'afraid', bgKey: 'c', bgImage: null, clips: ['cartographer/ruins.mp3'], secondsBeforeEnd: 5, defaultChoice: 1, countdown: 4, choices: [{ text: 'Step inside…', target: 'forest' }, { text: 'Back away slowly into the light…', target: 'spring' }] },
      forest: { id: 'forest', title: 'Something Moves', emotion: 'afraid', bgKey: 'c', bgImage: null, clips: ['cartographer/forest-a.mp3', 'cartographer/forest-b.mp3'], secondsBeforeEnd: 5, defaultChoice: 0, countdown: 4, choices: [{ text: 'Stand still and let it come to you…', target: 'end' }, { text: 'Run for the ship…', target: 'end' }] },
...
export const useStore = create((set, get) => ({
  ...
  addScene: () => set(s => {
    ...
    story.scenes[id] = {
      ...
      clips: [], secondsBeforeEnd: 5, defaultChoice: 0, countdown: 4, choices: []
    }
